...
<template>
  <!--
    shop Details dialog
  -->
  <div v-show="previewOpen" class="relative z-40" role="dialog" aria-modal="true">
    <!--
      ...
      Leaving: "transition-opacity ease-linear duration-300"
        ...
        To: "opacity-0"
    -->
    <div v-show="previewOpen" class="fixed inset-0 bg-carto-main bg-opacity-25 backdrop-blur-sm"
        ...
        <section class="flex flex-col w-full h-full">
          ...
          <template v-if="shop">
            ...
            <div class="flex flex-col flex-auto gap-2 p-3">
              <h3 class="lg lobster-two-bold">INFORMATIONS GÉNÉRALES</h3>
              <ShopContact :shop/>
              <ShopSocial :shop/>
